...
ALLOWED_ORIGINS = {
    "https://bustracingfullandfinal2.netlify.app/",
    "https://busmobile.onrender.com",
    "null",
}
...
def add_cors(response):
    ...
    if (origin in ALLOWED_ORIGINS
        ...
        response.headers["Access-Control-Allow-Origin"]  = "https://bustracingfullandfinal2.netlify.app/"
